...
class CommitteeService:
    ...
    def get_committees_by_neighborhood(
    ...
    def create_committee(
        self, committee_data: CommitteeCreate, created_by: int
    ) -> CommitteeResponse:
    ...
    def update_committee(
        self, committee_id: int, committee_data: CommitteeUpdate
    ) -> CommitteeResponse:
    ...
    def add_member(self, committee_id: int, user_id: int, role: str = "member") -> None:
        ...
        # Üye ekle
        member_data = {"committee_id": committee_id, "user_id": user_id, "role": role}
